    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div style="margin-left: 35px">
                <h5 style="margin-bottom: 15px">Edit Subsection</h5>
                <form:form action="/admin/subsection/${subsection.id}" modelAttribute="subsection" method="post">
                    <form:hidden path="id" />
                    ...
                    <div>
                        ...
                        <form:select path="section.id" required="true"
                                     id="section" name="section" class="form-select"
                                     style="border: 1px solid #bfbfbf; border-radius: 5px; width: 12%;">
                            <c:forEach var="section" items="${sections}">
                                <option
                                        value="${section.id}" ${section.id == subsection.section.id ? "selected" : ""}>${section.name}</option>
                            </c:forEach>
                        </form:select>
                    </div>
